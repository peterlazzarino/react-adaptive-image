...
Type: bool  Default: false  IsRequired: No

If true will render the image as a background image with the background-image attribute set to the source of the lazy loaded image.
